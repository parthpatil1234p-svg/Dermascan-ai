...
async def list_catalogue_products(
    ...
    skin_type: Literal.__getitem__(SKIN_TYPES) | None = None,
    visible_concern: Literal.__getitem__(VISIBLE_CONCERNS) | None = None,
    ...
    availability: Literal.__getitem__(AVAILABILITY_STATUSES) | None = None,
    min_price: float | None = Query(None, ge=0, le=1_000_000),
    max_price: float | None = Query(None, ge=0, le=1_000_000),
    fragrance_status: Literal.__getitem__(FRAGRANCE_STATUSES) | None = None,
    data_type: Literal.__getitem__(PUBLIC_DATA_TYPES) | None = None,
    sort: Literal.__getitem__(SORT_OPTIONS) = "name_asc",
