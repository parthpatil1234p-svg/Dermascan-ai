...
export default function ReportsPage() {
  ...
  return <section className="px-4 py-14 sm:px-6 lg:px-8"><PageHeader eyebrow="Owner-protected history" title="Final Report History" description="View, print, export, or archive versioned guidance reports without exposing facial images or private identifiers." /><div className="mx-auto max-w-7xl"><AdBanner className="mb-6" /><ErrorMessage message={error} />
